...
@section('description', 'Практические разборы разработки, диагностики сайтов, интернет-магазинов, SEO, автоматизации и собственных инструментов Code Doctor.')
                    ...
                    >
                        ...
                        <a href="{{ route('blog.show', $article->slug) }}"
                           class="block">
                            ...
                            @if($article->image)
                                <div class="h-56 overflow-hidden bg-background">
                                    <img
